...
import styles from "./DocumentCapture.module.sass";
import cn from "classnames";
import { documentCaptureMessages } from "../../../utils/messages";
...
const DocumentCapture = () => {
  ...
  useEffect(() => {
    const sortedMessages = documentCaptureMessages.sort(
